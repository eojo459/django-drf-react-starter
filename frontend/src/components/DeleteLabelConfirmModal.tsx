...
interface DeleteLabelConfirmModal {
    modalOpened: boolean;
    isMobile: boolean;
    closeModal: () => void;
...
export default function DeleteLabelConfirmModal(props: DeleteLabelConfirmModal) {
            ...
            >
                <Grid c="#dcdcdc">
                    <Grid.Col span={{ base: 12 }}>
                        <Text size="xl" fw={500}>Are you sure you want to remove this label?</Text>
                    </Grid.Col>

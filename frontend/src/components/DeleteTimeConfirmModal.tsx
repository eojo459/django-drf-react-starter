...
interface DeleteTimeConfirmModal {
    modalOpened: boolean;
    isMobile: boolean;
    //businessId: string;
    closeModal: () => void;
...
export default function DeleteTimeConfirmModal(props: DeleteTimeConfirmModal) {
            ...
            >
                <Grid c="#dcdcdc">
                    <Grid.Col span={{ base: 12 }}>
                        <Text size="xl" fw={500}>Are you sure you want to delete this time entry?</Text>
                    </Grid.Col>
